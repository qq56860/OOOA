...
.head {
    ...
    if(r == true){
        window.location.href="admin/addM?name="+name+"&password="+password+"&email="+email+"&sex="+sex+"&nation="
	...
	<div style="margin-left:100px">
     ...
     border-bottom-style: none;"" >
			<label style="position:absolute;left:36;top:64px">密码 ：</label><input
				class="dt" type="text" name="password" id="password" value=""
...
<!-- 学历等项 -->
    ...
    <button class="btn btn-info"  style="position:absolute;right:100px;top:780px" onclick="add()"><i class="glyphicon glyphicon-plus"></i> 添加</button>
    </div>
 </div>
</body>
