...
<script charset="utf-8" src="/OA/kindeditor/plugins/code/prettify.js"></script>
   <style type="text/css">
    ...
    if(r == true){
        window.location.href="notice/updateN?nid="+nid+"&title="+title+"&summary="+summary+"&contents="+contents+"&nissuer="+nissuer;
    }
    }
    </script>
			...
			<div class="tabbable" id="tabs-825041">
				...
				<div style="padding:10px">
						<p style="margin-top:10px">
                          ...
                          <input type="text" name="title" id="title" value="${notice.nSummary }">
						</p>
						<p>
						  <label for="textfield2">摘要 :</label>
                          <input type="text" name="summary" id="summary" value="${notice.nSummary }">
					  ...
					  <p>
						...
						<input type="text" name="issuer" id="issuer" value="${notice.issuer }">
						</p>
