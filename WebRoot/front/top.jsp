...
function openit(){
  ...
  <div id="wrapper">
    <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
          ...
          <li class="dropdown">
              <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><span style="color: white">你好，员工：${User.eName }</span>
              <img src=${ee.img }><span class="badge"></span></a>
            ...
            <li class="m_2"><a href="front/personalInfo.jsp" target="main"><i class="fa fa-bell-o"></i> 修改个人资料 <span class="label label-info"></span></a></li>
    ...
    <iframe src="front/main.jsp" name="main" width="100%" height="600px" scrolling="auto" style="margin-top:52px;border: 0; "></iframe>
